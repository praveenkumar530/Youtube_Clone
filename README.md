...
This project is hosted on Netlify and can be accessed here [Youtube Clone](https://pk-youtube-clone.netlify.app/)
 
* if you see Api key error messages please change them in api.js file and try again

 ## Instructions for the assignment
* Clone this repo on your machine.
* Use your IDE of choice to complete the assignment.
* When you are done with the solution and have pushed it to the repo, [you can submit the assignment here](https://app.snapcode.review/submission_links/01e4e651-c3fc-4188-a51b-0ce9be6dfbc7).
